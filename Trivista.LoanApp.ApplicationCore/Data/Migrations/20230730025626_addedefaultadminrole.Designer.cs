...
namespace Trivista.LoanApp.ApplicationCore.Data.Migrations
{
    ...
    [Migration("20230730025626_addedefaultadminrole")]
    partial class addedefaultadminrole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 7, 30, 2, 56, 25, 963, DateTimeKind.Utc).AddTicks(9940),
                            Description = "Default super admin role",
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 7, 30, 2, 56, 25, 963, DateTimeKind.Utc).AddTicks(9940),
                            Name = "SuperAdmin"
                        });
                });
