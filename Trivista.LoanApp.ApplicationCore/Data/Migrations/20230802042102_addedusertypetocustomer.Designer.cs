...
namespace Trivista.LoanApp.ApplicationCore.Data.Migrations
{
    ...
    [Migration("20230802042102_addedusertypetocustomer")]
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 8, 2, 4, 21, 1, 513, DateTimeKind.Utc).AddTicks(1100),
                            Description = "Default super admin role",
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 8, 2, 4, 21, 1, 513, DateTimeKind.Utc).AddTicks(1100),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 8, 2, 4, 21, 1, 477, DateTimeKind.Utc).AddTicks(8870),
