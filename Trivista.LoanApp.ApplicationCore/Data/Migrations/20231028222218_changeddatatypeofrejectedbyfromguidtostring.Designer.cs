...
namespace Trivista.LoanApp.ApplicationCore.Data.Migrations
{
    ...
    [Migration("20231028222218_changeddatatypeofrejectedbyfromguidtostring")]
    partial class changeddatatypeofrejectedbyfromguidtostring
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 10, 28, 22, 22, 17, 582, DateTimeKind.Utc).AddTicks(1092),
                            Description = "Default super admin role",
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 10, 28, 22, 22, 17, 582, DateTimeKind.Utc).AddTicks(1097),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 10, 28, 22, 22, 17, 545, DateTimeKind.Utc).AddTicks(3548),
