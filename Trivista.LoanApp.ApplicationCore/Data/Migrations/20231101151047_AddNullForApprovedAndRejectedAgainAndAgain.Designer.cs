...
namespace Trivista.LoanApp.ApplicationCore.Data.Migrations
{
    ...
    [Migration("20231101151047_AddNullForApprovedAndRejectedAgainAndAgain")]
    partial class AddNullForApprovedAndRejectedAgainAndAgain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 11, 1, 15, 10, 46, 513, DateTimeKind.Utc).AddTicks(7527),
                            Description = "Default super admin role",
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 11, 1, 15, 10, 46, 513, DateTimeKind.Utc).AddTicks(7529),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 11, 1, 15, 10, 46, 481, DateTimeKind.Utc).AddTicks(617),
