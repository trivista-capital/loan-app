...
namespace Trivista.LoanApp.ApplicationCore.Data.Migrations
{
    ...
    [Migration("20231214100620_AddedLocationToCustomer")]
    partial class AddedLocationToCustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 12, 14, 10, 6, 19, 516, DateTimeKind.Utc).AddTicks(5229),
                            Description = "Default super admin role",
                            IsDeleted = false,
                            LastModified = new DateTime(2023, 12, 14, 10, 6, 19, 516, DateTimeKind.Utc).AddTicks(5233),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 12, 14, 10, 6, 19, 454, DateTimeKind.Utc).AddTicks(3307),
