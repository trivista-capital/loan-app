...
namespace Trivista.LoanApp.ApplicationCore.Data.Migrations
{
    ...
    [Migration("20240520151739_ChangeRemittaUserType")]
    partial class ChangeRemittaUserType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2024, 5, 20, 15, 17, 39, 37, DateTimeKind.Utc).AddTicks(4208),
                            Description = "Default super admin role",
                            IsDeleted = false,
                            LastModified = new DateTime(2024, 5, 20, 15, 17, 39, 37, DateTimeKind.Utc).AddTicks(4214),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Trivista.LoanApp.ApplicationCore.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 5, 20, 15, 17, 38, 979, DateTimeKind.Utc).AddTicks(7649),
